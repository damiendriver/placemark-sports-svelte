<div class="box has-text-centered columns m-2">
    <a href="/clubs" class="column is-2">
        <i class="fas fa-home fa-3x" style="color:rgb(63, 122, 139)" />
    </a>
    <a href="/sportgrounds" class="column is-2">
        <i class="fas fa-flag fa-3x" style="color:rgb(63, 122, 139)" />
    </a>
    <a href="/dashboard" class="column is-2">
        <i class="fas fa-list fa-3x" style="color:rgb(63, 122, 139)" />
    </a>
    <a href="/map" class="column is-2">
